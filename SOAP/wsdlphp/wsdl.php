 ...
 *****************************************************************************/
    ...
    $functions[] = array("funcName" => "ChooseColour",
                         ...
                         "soapAddress" => "http://krprtl.bakulev.ru/mostarikov/soap_testGenerator/soap-service.php"
                         );
						 
    $functions[] = array("funcName" => "ChoosePatientByID",
                         "doc" => "Get Patient data by ID",
                         "inputParams" => array(array("name" => "ID_MIS", "type" => "int"),
                                                array("name" => "COUNTRY", "type" => "string"),
                                                array("name" => "SURNAME", "type" => "string"),
                                                array("name" => "NAME", "type" => "string"),
                                                array("name" => "PATRONYMIC", "type" => "string"),
                                                array("name" => "BIRTHDAY", "type" => "string"),
                                                array("name" => "REGION", "type" => "string"),
                                                array("name" => "CITY", "type" => "string"),
                                                array("name" => "SEX", "type" => "string")),
                         "outputParams" => array(array("name" => "ID_MIS", "type" => "int"),
                                                array("name" => "COUNTRY", "type" => "string"),
                                                array("name" => "SURNAME", "type" => "string"),
                                                array("name" => "NAME", "type" => "string"),
                                                array("name" => "PATRONYMIC", "type" => "string"),
...
function DisplayXML($xmlformat=true) {
    ...
    for ($i=0;$i<count($functions);$i++) {
        ...
        if (array_key_exists("outputParams", $functions[$i])) {
           ...
           $str .= $t3 . '<s:complexType><s:sequence>' . "\n";
           for ($j=0;$j<count($functions[$i]['outputParams']);$j++) {
               $str .= $t4 . '<s:element minOccurs="0" maxOccurs="unbounded" ';
